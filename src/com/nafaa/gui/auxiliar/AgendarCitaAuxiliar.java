...
public class AgendarCitaAuxiliar extends JPanel implements ActionListener {
	/**
	 * 
	 */
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == btnNewButton){
			...
			boton.addActionListener(new ActionListener(){
				...
				@Override
				public void actionPerformed(ActionEvent e) {
					String nombrePaciente = javax.swing.JOptionPane.showInputDialog(this,"Nombre Paciente");
					String hora = "";
					String dia = ""+calendarAgent.getjTable().getValueAt(calendarAgent.getjTable().getSelectedRow(), calendarAgent.getjTable().getSelectedColumn());
					boolean value;
					...
					String curp = Database.getDatabase().queryDMLExtract("idCurp","SELECT idCurp FROM Naafa_corp.Paciente WHERE NombreCompleto='"+nombrePaciente+"'");
