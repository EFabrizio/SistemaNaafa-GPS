...
Estado(10)
 */
public class ActualizarDato extends javax.swing.JFrame {
...
"OC","PL","QT","QR","SP","SL","SR","TC","TS","TL","VZ","YN","ZS"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Actualiza Datos");
        ...
        jPanel2Layout.setHorizontalGroup(
        	jPanel2Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel2Layout.createSequentialGroup()
        			...
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(jPasswordField1, 368, 368, 368)
        				.addComponent(jPasswordField2, Alignment.TRAILING, 368, 368, 368))
        			.addContainerGap())
        );
    ...
    private void jButton1MouseClicked(ActionEvent e) {//GEN-FIRST:event_jButton1MouseClicked
       ...
       // if(s==1 && ss==1){
        ...
        //}
       // Database.getDatabase().queryDDL("UPDATE Naafa_corp.Usuario (Nombre_Usuario,Contraseña,Tipo,Estado) "
        //		+ "VALUES('"+jTextField1.getText()+"','"+jPasswordField1.getText()+"','Paciente','Activo') ");
        //CURP PENDIENTE...
       Database.getDatabase().easyQuery("UPDATE Naafa_corp.Paciente, Naafa_corp.Usuario SET Naafa_corp.Paciente.NombreCompleto = '"+jTextField3.getText()+" "+jTextField4.getText()+" "+jTextField7.getText()+"', Naafa_corp.Paciente.Sexo = 'M', Naafa_corp.Paciente.Tipo_Sangre='o+', Naafa_corp.Paciente.FechaNacimiento = '1995-02-20', Naafa_corp.Paciente.Domicilio = '"+jTextField5.getText()+"', Naafa_corp.Usuario.Contraseña = '"+jPasswordField1.getText()+"' where  Naafa_corp.Paciente.idUsuario = "+Ventana.idUsuario+" and Naafa_corp.Usuario.idUsuario = Naafa_corp.Paciente.idUsuario");
